...
def haveWhnf(target: Term)(given glbCtx: GlobalContext) = AssertionBase[Term]{ (t, objective) =>
...
def checkWithType(ty: Term)(given ctx: TypeContext)(given glbCtx: GlobalContext) = AssertionBase[Term] { (t, objective) =>
